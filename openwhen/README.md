...
> Open When lives in the [Ark-App](../README.md) repo alongside its sister
> product **Ark** — cryptographic time capsules. Open When's date locks are
> sealed by trust, like paper; Ark's are sealed by timelock encryption. Pick
> the temperament the moment calls for.
